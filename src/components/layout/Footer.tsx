        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <motion.div variants={staggerItem} className="lg:col-span-2">
            <Link href="/" className="inline-block mb-4">
              <span className="text-3xl font-bold font-[family-name:var(--font-playfair)] text-gradient-gold">
                Soulmates Orchestra
              </span>
            </Link>
            ...
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-[#1A1A1A] flex items-center justify-center text-[#A1A1A1] hover:bg-[#C9A962] hover:text-[#0A0A0A] transition-all duration-300"
          ...
          <motion.div variants={staggerItem}>
            <h4 className="text-lg font-semibold text-[#FAFAFA] mb-4 font-[family-name:var(--font-playfair)]">
              {t("footer.quickLinks")}
            </h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="text-[#A1A1A1] hover:text-[#C9A962] transition-colors"
                  >
