...
import { GALLERY_IMAGES, GalleryCategory } from "@/lib/constants";
    ...
    <>
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-20">
        ...
        >
          ...
          >
            <Camera size={32} className="text-[#C9A962]" />
          </motion.div>
              ...
              <button
                ...
                className={cn(
                  ...
                  activeCategory === category
                    ...
                    : "bg-[#1A1A1A] text-[#A1A1A1] hover:text-[#FAFAFA] border border-[#252525] hover:border-[#C9A962]/50"
                )}
              >
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute bottom-4 left-4 right-4 text-left opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <span className="text-sm text-[#C9A962] capitalize">
